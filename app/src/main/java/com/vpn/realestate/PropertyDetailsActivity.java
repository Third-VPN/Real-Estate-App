...
public class PropertyDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager manager = new LinearLayoutManager(PropertyDetailsActivity.this);
    ...
    private void fillPropertyPhotos() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(PropertyDetailsActivity.this);
    ...
    private void filPropertyData() {
        ...
        RequestQueue requestQueue1 = Volley.newRequestQueue(PropertyDetailsActivity.this);
        ...
        try {
            ...
            if (success == 1) {
                ...
                if (jsonArray.length() > 0) {
                    ...
                    PropertyPhotoAdapter adapter = new PropertyPhotoAdapter(PropertyDetailsActivity.this, photoList);
